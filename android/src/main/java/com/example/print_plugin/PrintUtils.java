...
public class PrintUtils {
	...
	public static void initPrintUtils(Context context1) {
...
//		}
	 ...
	 * 
	 * @param size
	 *            文字大小，其中1为正常字体，2位双倍宽高字体，暂不支持其他字体大小
	 * @param align
	 *            对齐方式，其中0为居左，1为居中，2为居右
	 * @param text
	 *            打印的文字
     * @param tearPape
     *            打印完是否要撕纸，设为true时候会打印完多走3空行，方便撕纸操作
	 */
...
//						bitmap=zoomImg(bitmap,200,bitmap.getHeight());
	 ...
	 *            对齐方式，其中0为居左，1为居中，2为居右
	 * @param width
	 *            打印一维码宽度，由于58纸张限制，最大打印宽度为384，超过则可能无法打印
	 * @param height
	 *            打印一维码的高度
	 * @param data
	 *            一维码的内容（不能是中文，否则会报错）
